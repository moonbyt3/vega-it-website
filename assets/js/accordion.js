...
{
    const materialNameCells = document.getElementsByClassName('material-name-wrapper');
    ...
    for (let materialCell of materialNameCells) {
        ...
        materialCell.addEventListener('click', () => {
            ...
            let elementIndex = materialCell.getAttribute('data-index');
            
            if (isClicked === false) {
                materialCell.innerHTML += `<br><br>
